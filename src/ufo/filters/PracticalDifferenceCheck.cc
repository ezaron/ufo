...
PracticalDifferenceCheck::PracticalDifferenceCheck(ioda::ObsSpace & obsdb, const Parameters_ & parameters,
                                 std::shared_ptr<ioda::ObsDataVector<int> > flags,
                                 std::shared_ptr<ioda::ObsDataVector<float> > obserr)
  : FilterBase(obsdb, parameters, flags, obserr),
    parameters_(parameters)
{
  oops::Log::trace() << "PracticalDifferenceCheck contructor starting" << std::endl;
}

// -----------------------------------------------------------------------------

PracticalDifferenceCheck::~PracticalDifferenceCheck() {
  oops::Log::trace() << "PracticalDifferenceCheck destructed" << std::endl;
}

// -----------------------------------------------------------------------------

void PracticalDifferenceCheck::applyFilter(const std::vector<bool> & apply,
                                  const Variables & filtervars,
                                  std::vector<std::vector<bool>> & flagged) const {
  oops::Log::trace() << "PracticalDifferenceCheck priorFilter" << std::endl;
...
void PracticalDifferenceCheck::print(std::ostream & os) const {
  os << "PracticalDifferenceCheck::print not yet implemented ";
}
