...
#ifndef UFO_FILTERS_PRACTICALDIFFERENCECHECK_H_
#define UFO_FILTERS_PRACTICALDIFFERENCECHECK_H_
...
class PracticalDifferenceCheckParameters : public FilterParametersBase {
  OOPS_CONCRETE_PARAMETERS(PracticalDifferenceCheckParameters, FilterParametersBase)
...
class PracticalDifferenceCheck : public FilterBase,
                        private util::ObjectCounter<PracticalDifferenceCheck> {
 public:
  /// The type of parameters accepted by the constructor of this filter.
  /// This typedef is used by the FilterFactory.
  typedef PracticalDifferenceCheckParameters Parameters_;

  static const std::string classname() {return "ufo::PracticalDifferenceCheck";}

  PracticalDifferenceCheck(ioda::ObsSpace &, const Parameters_ &,
                  std::shared_ptr<ioda::ObsDataVector<int> >,
                  std::shared_ptr<ioda::ObsDataVector<float> >);
  ~PracticalDifferenceCheck();
...
#endif  // UFO_FILTERS_PRACTICALDIFFERENCECHECK_H_
